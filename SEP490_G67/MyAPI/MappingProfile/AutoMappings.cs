...
namespace MyAPI.MappingProfile
{
    public class AutoMappings : Profile
    {
        public AutoMappings() 
        {
            ...
            CreateMap<Vehicle, VehicleBasicDto>().ReverseMap();
            ...
            CreateMap<Vehicle, VehicleImportDTO>().ReverseMap();
            CreateMap<VehicleImportDTO, Vehicle>().ReverseMap();
            ...
            CreateMap<Trip,TripByIdDTO>().ReverseMap();
            ...
            CreateMap<TicketByIdDTOs, Ticket>()
            .ForMember(dest => dest.TypeOfPayment, opt => opt.Ignore());
